...
export const metadata: Metadata = {
    ...
    metadataBase: new URL("https://hijabcantikngewe.pages.dev"),
    alternates: {
        canonical: `/`,
    },
    openGraph: {
...
export default function RootLayout({
    ...
    const jsonLd = {
        ...
        "name": `${SITENAME}`,
        "description": `${SITENAME} Video Bokep Indo Jepang Jav Barat Simontok Viral Terbaru Bocil Ngentot Jilbab Smp Mama Sma korea china tante live paksa ngentot abg cewek pelajar.`,
        "logo": "https://hijabcantikngewe.pages.dev/favicon.ico",
        "url": "https://hijabcantikngewe.pages.dev",
        "founder":{
            "@type":"Person",
            "name":"admin",
            "url":"https://hijabcantikngewe.pages.dev"
        ...
        "potentialAction": { 
        "@type": "SearchAction", 
          "target": "https://hijabcantikngewe.pages.dev/?q={search_term}", 
